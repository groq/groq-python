...
```python
from groq.types import ModelRetrieveResponse, ModelListResponse
```

Methods:

- <code title="get /openai/v1/models/{model}">client.models.<a href="./src/groq/resources/models.py">retrieve</a>(model) -> <a href="./src/groq/types/model_retrieve_response.py">ModelRetrieveResponse</a></code>
