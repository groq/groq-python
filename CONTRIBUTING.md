...
```bash
pip install git+ssh://git@github.com:definitive-io/groqcloud-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/definitive-io/groqcloud-python/actions/workflows/publish-pypi.yml). This will require a setup organization or repository secret to be set up.
